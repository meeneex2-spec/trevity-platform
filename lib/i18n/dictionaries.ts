...
export const dictionaries: Record<Locale, Dictionary> = {
  ko: {
    ...
    what: {
      ...
      desc: '트래비티는 브랜드와 인플루언서를 연결해 새로운 트렌드 경험과 콘텐츠 기회를 제공합니다. 여행지 체험부터 신제품 체험까지, 단순한 광고가 아닌 실제 경험을 기반으로 콘텐츠를 만듭니다.',
      f1Title: '글로벌 캠페인', f1Desc: '호텔, 레스토랑, 액티비티 등 여행 캠페인부터 신제품 체험 캠페인까지 참여 가능',
