...
export const dictionaries: Record<Locale, Dictionary> = {
  ...
  my: {
    ...
    finalCta: {
      title1: 'အခုပဲ ကမ္ဘာလုံးဆိုင်ရာ ခရီးသွား Campaign ကို စတင်လိုက်ပါ', title2: '',
      desc: 'Trevity နဲ့အတူ ခရီးသွားအတွေ့အကြုံသစ်တွေနဲ့ Content တွေကို ဖန်တီးလိုက်ပါ။',
      cta: 'Influencer အဖြစ် စတင်ရန် →',
      check1: 'အခမဲ့ စာရင်းသွင်း', check2: 'နိုင်ငံ ၈ နိုင်ငံရဲ့ Campaign များ', check3: 'ကမ္ဘာ့အဆင့်မီ Brand တွေနဲ့ လက်တွဲလုပ်ဆောင်ခွင့်',
    },
    footer: {
